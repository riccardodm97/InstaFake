...
public final class InstaMetrics {
	...
	private final static int MAX_NUM_HASHTAG=4;        //numero medio di hashtag per post di utente medio 

	
	public boolean too_many_hashtag(double num_hashtag) {
		if((num_hashtag-InstaMetrics.MAX_NUM_HASHTAG)>0) return true;
		return false;
	}
	
	
	//calcola scostamento di cfr rispetto alle metriche
	...
	//calcola scostamento di lfr rispetto alle metriche
